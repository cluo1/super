...
// import './App.css';
import { Player, ControlBar, PlayToggle,BigPlayButton,VolumeMenuButton ,CurrentTimeDisplay ,TimeDivider,DurationDisplay  } from 'video-react';
...
export default class App extends Component{
  ...
  changeCurrentTime(seconds) {
    return () => {
      ...
      console.log("检查视频是不是已经播放完毕："+this.player.getState().player.ended)
